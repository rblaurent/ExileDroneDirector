...
copy, and semantic validation. The functions are deliberately not dispatched
yet; P-toggle routing, manual-input arbitration, exit cleanup, and PIE movement
acceptance form the next independent checkpoint.
