...
state on completion. It does not use frame delta or integrate the prior pose.

The live compiled round-trips contain 17/67, 36/141, and 3/16 nodes/pins. The
...
The next gate is deterministic two-player PIE acceptance of invalid drafts,
start snap, midpoint/endpoint evaluation, completion, P-stop behavior, client
isolation, and unchanged pawn/controller possession. Cook and Workshop remain
