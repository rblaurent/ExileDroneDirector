"""Build the ordered desired-stream compile transaction."""
from __future__ import annotations
import argparse, importlib.util, re, sys
from pathlib import Path
FUNCTION="CompileAirframeDesiredStreamV1"
