...
SCALARS=(("AirframeDocumentAdapterStageValidV2","bool","false"),("AirframeDocumentAdapterDurationAccumulatorV2","real","0.0"),("AirframeDocumentAdapterCompileValidV2","bool","false"),("AirframeDocumentAdapterFailureCodeV2","string",""),("AirframeDocumentDiagnosticStageValidV2","bool","false"),("AirframeDocumentDiagnosticScratchBodyLeftRateV2","vector","0, 0, 0"),("AirframeDocumentDiagnosticScratchGimbalLeftRateV2","vector","0, 0, 0"),("AirframeDocumentDiagnosticScratchBodyAngularRateJumpV2","real","0.0"),("AirframeDocumentDiagnosticCountV2","int","0"),("AirframeDocumentDiagnosticsValidV2","bool","false"))
def load(root):
