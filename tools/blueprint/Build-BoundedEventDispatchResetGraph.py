...
SCALARS = (
    ...
    ("EventLedgerCommitValidV1", "bool", "false"),
    ("EventManualResetResultValidV1", "bool", "false"),
    ("EventCandidateAlreadyExecutedV1", "bool", "false"),
    ("EventManualResetCueFoundV1", "bool", "false"),
    ("EventManualResetRemovedAnyV1", "bool", "false"),
    ("EventManualResetCandidateValidV1", "bool", "false"),
    ("EventAdapterExecutionResultValidV1", "bool", "false"),
    ("EventAdapterExecutionSucceededV1", "bool", "false"),
    ("EventAdapterExecutionCodeV1", "string", ""),
