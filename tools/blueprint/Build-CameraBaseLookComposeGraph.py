"""Build the policy-free ordered named camera-look composition coordinator."""
...
def main() -> None:
    ...
    spec = importlib.util.spec_from_file_location("edd_camera_look_compose_base", path)
