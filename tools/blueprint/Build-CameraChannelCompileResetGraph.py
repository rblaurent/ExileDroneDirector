"""Build the fail-closed camera channel-assembly compile reset."""
from __future__ import annotations
import argparse,importlib.util,re,sys
from pathlib import Path
FUNCTION="ResetCameraChannelCompileV1"
ARRAYS=(("CameraChannelCandidateKeyOffsetsV1","int"),("CameraChannelCandidateKeyCountsV1","int"),("CameraChannelCandidateKeyTimesV1","real"),("CameraChannelCandidateDomainValuesV1","real"),("CameraChannelCandidateInterpolationModesV1","string"),("CameraChannelCandidateArriveTangentsV1","real"),("CameraChannelCandidateLeaveTangentsV1","real"),("CameraChannelCandidateDomainsV1","string"),("CameraChannelResultValuesV1","real"),("CameraChannelResultVelocitiesV1","real"),("CameraChannelResultAccelerationsV1","real"))
SCALARS=(("CameraChannelCompileValidV1","bool","false"),("CameraChannelFailureCodeV1","string",""),("CameraChannelScratchChannelIndexV1","int","0"),("CameraChannelScratchKeyIndexV1","int","0"),("CameraChannelScratchValidV1","bool","false"),("CameraChannelResultFilmbackPresetIdV1","string",""),("CameraChannelResultFilmbackSensorWidthMmV1","real","0.0"),("CameraChannelResultFilmbackSensorHeightMmV1","real","0.0"),("CameraChannelResultCompleteV1","bool","false"),("CameraChannelResultValidV1","bool","false"))
def load(root):
 p=root/"tools/blueprint/Build-OrientationTrackResetGraph.py";s=importlib.util.spec_from_file_location("edd_camera_channel_reset_base",p);m=importlib.util.module_from_spec(s);sys.modules[s.name]=m;s.loader.exec_module(m);return m
...
def main():
 ...
 bp.connect(entry,"then",chain[0],"execute");[bp.connect(left,"then",right,"execute") for left,right in zip(chain,chain[1:])]
