"""Build the policy-free ordered camera focus compile coordinator."""
...
FUNCTION = "CompileCameraFocusDistanceChannelV1"
CALLS = ("ResetCameraFocusCompileV1", "ValidateCameraFocusInputsV1", "BuildCameraFocusDistanceCandidatesV1", "CommitCameraFocusDistanceChannelV1")
...
def main():
    ...
    spec = importlib.util.spec_from_file_location("edd_camera_focus_compile_base", path)
