"""Build the policy-free four-source playback evaluation coordinator."""
...
FUNCTION = "EvaluateCameraPlaybackSourcesV1"
CALLS = (
...
def main() -> None:
    ...
    spec = importlib.util.spec_from_file_location("edd_playback_source_evaluator_base", path)
