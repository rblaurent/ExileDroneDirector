"""Build the fail-closed playback-native application reset graph."""
...
FUNCTION = "ResetCameraPlaybackNativeApplicationResultV1"
SCALARS = (
    ("CameraPlaybackNativeInputValidV1", "bool", "false"),
    ("CameraPlaybackNativeStageValidV1", "bool", "false"),
    ("CameraPlaybackNativePreflightValidV1", "bool", "false"),
    ("CameraPlaybackNativeResultValidV1", "bool", "false"),
    ("CameraPlaybackNativeFailureCodeV1", "string", ""),
)
...
def main() -> None:
    ...
    camera = load(
        ...
        "edd_playback_native_reset_camera",
    )
