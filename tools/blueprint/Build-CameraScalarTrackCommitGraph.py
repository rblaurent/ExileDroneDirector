...
def main():
 ...
 def and_all(values,x,y):
  ...
  return current
 invalidate=set_("CameraScalarTrackCompileValidV1","bool",1328,528,"false");bp.connect(b.entry,"then",invalidate,"execute");stage=get("CameraScalarTrackScratchValidV1","bool",0,0);stage_guard=b.add("stage_guard","branch",1552,528);bp.connect(invalidate,"then",stage_guard,"execute");bp.connect(stage,"CameraScalarTrackScratchValidV1",stage_guard,"Condition")
