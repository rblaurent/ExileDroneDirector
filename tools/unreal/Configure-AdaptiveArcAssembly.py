"""Create and verify the typed adaptive arc-table transaction seam."""
...
PREFIX = "EDD_ADAPTIVE_ARC_CONFIG"
CLIENT = "/Game/Mods/ExileDroneDirector/Core/Client/BPC_EDD_ClientDirector"
ROOT = Path(__file__).resolve().parents[2]
SCHEMA = json.loads((ROOT / "tools/trajectory/adaptive_arc_blueprint_schema.json").read_text(encoding="utf-8"))
...
if vector is None:
    raise RuntimeError("native Vector unavailable")
types = {
