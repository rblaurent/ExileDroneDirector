"""Create and verify the typed sampled desired-stream seam on Client Director.
...
PREFIX = "EDD_AIRFRAME_DESIRED_STREAM_CONFIG"
CLIENT = "/Game/Mods/ExileDroneDirector/Core/Client/BPC_EDD_ClientDirector"
ROOT = Path(__file__).resolve().parents[2]
SCHEMA = json.loads(
    (ROOT / "tools/trajectory/airframe_desired_stream_blueprint_schema.json").read_text(
        encoding="utf-8"
    )
)
