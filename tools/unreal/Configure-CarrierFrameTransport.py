"""Create and verify the independent carrier-frame schema on Client Director."""
from __future__ import annotations
import json
from pathlib import Path
import unreal

PREFIX="EDD_CARRIER_FRAME_CONFIG";CLIENT="/Game/Mods/ExileDroneDirector/Core/Client/BPC_EDD_ClientDirector";ROOT=Path(__file__).resolve().parents[2];SCHEMA=json.loads((ROOT/"tools/trajectory/carrier_frame_transport_blueprint_schema.json").read_text(encoding="utf-8"))
