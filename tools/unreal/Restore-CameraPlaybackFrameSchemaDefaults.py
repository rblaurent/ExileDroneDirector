"""Converge camera-playback class defaults after live probes."""
from __future__ import annotations
import json
from pathlib import Path
import unreal

PREFIX="EDD_CAMERA_PLAYBACK_DEFAULTS";CLIENT="/Game/Mods/ExileDroneDirector/Core/Client/BPC_EDD_ClientDirector";ROOT=Path(__file__).resolve().parents[2];SCHEMA=json.loads((ROOT/"tools/trajectory/camera_playback_frame_blueprint_schema.json").read_text(encoding="utf-8"))
